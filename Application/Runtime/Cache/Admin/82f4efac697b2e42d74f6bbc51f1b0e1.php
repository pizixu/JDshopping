...
<div class="main-div">
    <form name="main_form" method="POST" action="/shopping2test/index.php/Admin/Admin/add.html" enctype="multipart/form-data">
        <table cellspacing="1" cellpadding="3" width="100%">
            <tr>
                <td class="label">所在角色：</td>
                <td>
                <?php if(is_array($roleData)): $i = 0; $__LIST__ = $roleData;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><input  type="checkbox" name="role_id[]" value="<?php echo ($vo["id"]); ?>" /><?php echo ($vo["role_name"]); endforeach; endif; else: echo "" ;endif; ?>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label">是否启用 1：启用0：禁用：</td>
                <td>
