...
class PrivilegeModel extends Model 
{
	...
	protected $_validate = array(
		...
		array('module_name', '1,20', '模块名称的值最长不能超过 10 个字符！', 1, 'length', 3),
		array('controller_name', 'require', '控制器名称不能为空！', 1, 'regex', 3),
		array('controller_name', '1,20', '控制器名称的值最长不能超过 10 个字符！', 1, 'length', 3),
		array('action_name', 'require', '方法名称不能为空！', 1, 'regex', 3),
		array('action_name', '1,20', '方法名称的值最长不能超过 10 个字符！', 1, 'length', 3),
	...
	public function _before_delete($option)
	{
		...
		if($children)
		{
			...
			$this->execute("DELETE FROM sp_privilege WHERE id IN($children)");
		}
	}
}